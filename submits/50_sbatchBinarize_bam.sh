...
#SBATCH --output             binBam_%j.out           # Standard output
#SBATCH --error              binBam_%j.err           # Standard error

### SET I/O VARIABLES
CLEN=/home/groups/MaxsonLab/software/ChromHMM/CHROMSIZES/mm10.txt
CMARK=/home/groups/MaxsonLab/hortowe/tools/todo/50_cellMark_bam.txt
IN=$mlproj/process/30_filter/bam
OUT=$mlproj/process/50_binary/bam
